...
@Component({
  selector: 'app-popup-calendario-disponibilidad',
  templateUrl: './popup-calendario-disponibilidad.component.html',
  styleUrls: ['./popup-calendario-disponibilidad.component.scss']
})
export class PopupCalendarioDisponibilidadComponent implements OnInit {
