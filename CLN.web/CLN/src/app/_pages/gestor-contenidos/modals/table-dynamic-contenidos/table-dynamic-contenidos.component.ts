...
@Component({
  selector: 'app-table-dynamic-contenidos',
  templateUrl: './table-dynamic-contenidos.component.html',
  styleUrls: [
    './table-dynamic-contenidos.component.scss',
    "../../../../_shared/styles/tables.scss"
  ]
})
export class TableDynamicContenidosComponent implements OnInit, OnChanges {
