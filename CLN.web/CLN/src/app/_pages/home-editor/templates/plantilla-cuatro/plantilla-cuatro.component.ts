...
@Component({
  selector: 'app-plantilla-cuatro',
  templateUrl: './plantilla-cuatro.component.html',
  styleUrls: ['./plantilla-cuatro.component.scss', '../../../../_shared/styles/modals.scss', '../../../../_shared/styles/transition.scss'],
...
export class PlantillaCuatroComponent implements OnInit {
  ...
  constructor(private builderService: BuilderEditorService, private spinner: NgxSpinnerService, private router: Router) { }
