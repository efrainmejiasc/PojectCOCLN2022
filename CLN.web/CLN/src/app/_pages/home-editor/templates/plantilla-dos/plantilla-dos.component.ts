...
@Component({
  selector: 'app-plantilla-dos',
  templateUrl: './plantilla-dos.component.html',
  styleUrls: ['./plantilla-dos.component.scss', '../../../../_shared/styles/transition.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PlantillaDosComponent implements OnInit, AfterViewInit {
