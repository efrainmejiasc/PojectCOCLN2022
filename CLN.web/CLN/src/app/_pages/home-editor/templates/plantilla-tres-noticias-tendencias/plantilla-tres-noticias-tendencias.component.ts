...
@Component({
  selector: 'app-plantilla-tres-noticias-tendencias',
  templateUrl: './plantilla-tres-noticias-tendencias.component.html',
  styleUrls: ['./plantilla-tres-noticias-tendencias.component.scss', '../../../../_shared/styles/modals.scss', '../../../../_shared/styles/tables.scss', '../../../../_shared/styles/transition.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PlantillaTresNoticiasTendenciasComponent implements OnInit {
  ...
  constructor(private builderService: NewsTrendsService, private router: Router) { }
    ...
    if (this.templateOne) {
      ...
      this.builderService.uploadeMedia(file)
        .subscribe(data => {
          ...
          this.templateOne.attributes.filter(head => head.name == "media_url" + this.indexCarrouselEditor)[0].value = "../../../../../assets/upload/ComponentesMultimediaNewsTrends/" + data;
