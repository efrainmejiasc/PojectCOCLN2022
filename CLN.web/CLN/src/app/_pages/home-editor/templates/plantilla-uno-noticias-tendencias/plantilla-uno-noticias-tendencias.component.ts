...
@Component({
  selector: 'app-plantilla-uno-noticias-tendencias',
  templateUrl: './plantilla-uno-noticias-tendencias.component.html',
  styleUrls: ['./plantilla-uno-noticias-tendencias.component.scss', '../../../../_shared/styles/transition.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PlantillaUnoNoticiasTendenciasComponent implements OnInit {
  ...
  constructor(private builderService: NewsTrendsService, private spinner: NgxSpinnerService, private sanitizer: DomSanitizer, private router: Router) { }
