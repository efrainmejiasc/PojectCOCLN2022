...
@Component({
  selector: 'app-plantilla-cinco-noticias-tendencias',
  templateUrl: './plantilla-cinco-noticias-tendencias.component.html',
  styleUrls: ['./plantilla-cinco-noticias-tendencias.component.scss', '../../../../_shared/styles/modals.scss', '../../../../_shared/styles/transition.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PlantillaCincoNoticiasTendenciasComponent {
