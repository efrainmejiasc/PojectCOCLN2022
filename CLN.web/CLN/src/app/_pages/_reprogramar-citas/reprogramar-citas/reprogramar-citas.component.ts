...
@Component({
  ...
  styleUrls: ['./reprogramar-citas.component.scss']
})
...
export class ReprogramarCitasComponent implements OnInit {
  ...
  reprogramar(dialogTemplate: any) {
    ...
    this.citaActual.idState = 8;
    this.citaActual.idStateGuest = 8;
    this.citaActual.type = "Guest";
  ...
  cerrarDialogTemplate() {
    ...
    const queryParams = { tab: 'guest-scheduled-appointments', idcompany: this.empresaAnfitrionaSeleccionada.id }
