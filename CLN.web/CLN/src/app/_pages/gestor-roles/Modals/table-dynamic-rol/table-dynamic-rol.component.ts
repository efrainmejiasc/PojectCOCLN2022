...
@Component({
  selector: 'app-table-dynamic-rol',
  templateUrl: './table-dynamic-rol.component.html',
  styleUrls: [
    "../../../../_shared/styles/tables.scss",
    './table-dynamic-rol.component.scss']
})
export class TableDynamicRolComponent implements OnInit, OnChanges {
