...
{
    public class AvailableHoursCompanyEspecificDto
    {
        [JsonProperty("Id")]
        ...
        [JsonProperty("EspecificDate")]
        public DateTime EspecificDate { get; set; }

        [JsonProperty("IncludeExclude")]
        ...
        [JsonProperty("EspecificDay")]
        public AvailableHoursCompanyEspecificDetail EspecificDay { get; set; }
    }

    public class AvailableHoursCompanyEspecificDetail
    {
        [JsonProperty("Id")]
        public int Id { get; set; }

        [JsonProperty("IdAvailableHoursCompanyEspecific")]
        public int IdAvailableHoursCompanyEspecific { get; set; }
